...
-(id)init
{
    return [self initFromList:@"GoCommand BackCommand QuitCommand GrabCommand DropCommand ItemsCommand InventoryCommand WeightCommand PortalCommand SayCommand RemoveExit PlaceExit PassCodeCommand RemoveDelegateCommand PlaceDelegateCommand EquipCommand UnequipCommand GearCommand"];
}
